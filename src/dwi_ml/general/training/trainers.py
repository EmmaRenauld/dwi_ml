...
from dwi_ml.general.training.batch_loaders import (
...
from dwi_ml.general.training.utils.gradient_norm import compute_gradient_norm
from dwi_ml.general.training.utils.monitoring import (
...
class DWIMLTrainer:
    ...
    def back_propagation(self, loss):
        ...
        # Any other steps. Ex: clip gradients.
