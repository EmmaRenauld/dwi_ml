...
3. **Visualizing the logs**
    We have tools to help you supervise the results. For more information, see :ref:`visu_logs` for more information.

4. **Using your newly trained model!**
...
Here is watch your bash script will look like for Learn2track. See links above for a better explanation of each step::
...
Here is watch your bash script will look like for TractoTransformers. See links above for a better explanation of each step::
